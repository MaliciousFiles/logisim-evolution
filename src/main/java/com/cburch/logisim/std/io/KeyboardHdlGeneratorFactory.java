...
public class KeyboardHdlGeneratorFactory extends AbstractHdlGeneratorFactory {
    ...
    private void writePS2Library(String workPath) {
        String dir = workPath+AppPreferences.HdlType.get().toLowerCase()+"/ps2/";

        Hdl.writeArchitecture(dir, Arrays.stream("""
                /*****************************************************************************
                 *                                                                           *
        ...
        Hdl.writeArchitecture(dir, Arrays.stream("""
                ...
                """.split("\n")).toList(), "Altera_UP_PS2_Command_Out");
    }
