...
public class AbstractHdlGeneratorFactory implements HdlGeneratorFactory {
  ...
  @Override
  public List<String> getArchitecture(Netlist theNetlist, AttributeSet attrs, InstanceData data, String componentName, String workPath, BoardInformation board) {
    ...
    if (Hdl.isVhdl()) {
      ...
      contents.add("{{begin}}")
          .add(getModuleFunctionality(theNetlist, attrs, data, componentName, workPath, board).getWithIndent())
      ...
      body.empty()
          ...
          .add(getModuleFunctionality(theNetlist, attrs, data, componentName, workPath, board));
  ...
  public LineBuffer getModuleFunctionality(Netlist netlist, AttributeSet attrs, InstanceData data, String componentName, String workPath, BoardInformation board) {
    return getModuleFunctionality(netlist, attrs);
  }
