...
public interface HdlGeneratorFactory {
  ...
  default List<String> getArchitecture(Netlist theNetlist, AttributeSet attrs, String componentName) {
    return getArchitecture(theNetlist, attrs, null, componentName, null, null);
  }

  default List<String> getArchitecture(Netlist theNetlist, AttributeSet attrs, InstanceData data, String componentName, String workPath, BoardInformation board) {
    return getArchitecture(theNetlist, attrs, componentName);
  }
